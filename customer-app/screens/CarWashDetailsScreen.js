...
export default function CarWashDetailsScreen({ navigation, route }) {
  ...
  const { serviceTitle = "Basic Routine Cleaning", price = "₹99", duration = "30 mins" } = route.params || {};
  ...
  const renderBottomSheetContent = () => (
    ...
    >
      <Text style={styles.categoryText}>CAR WASH SERVICE</Text>
      ...
      <View style={styles.detailsSection}>
        ...
        <Text style={styles.bottomSheetText}>
          Our professional car wash service provides comprehensive cleaning for your vehicle. 
          We use premium products and eco-friendly solutions to ensure your car looks spotless 
          while being gentle on the environment. Our certified technicians are trained to handle 
          all types of vehicles with care and precision.
        </Text>
        ...
        <Text style={styles.bottomSheetText}>
          ...
          pH-balanced soap. Each section of your vehicle is carefully cleaned and dried with 
          microfiber towels to prevent water spots. The interior receives detailed attention with 
          professional-grade vacuuming and cleaning products safe for all surfaces.
        </Text>

        <Text style={styles.bottomSheetSubtitle}>Benefits:</Text>
        <Text style={styles.bottomSheetText}>
          • Protects your vehicle's paint and finish{'\n'}
        ...
        <Text style={styles.bottomSheetText}>
          With over 5 years of experience in the automotive care industry, we've built a reputation 
          ...
          products that are safe for your vehicle and the environment. Customer satisfaction is our 
        ...
        <Text style={styles.bottomSheetText}>
          ...
          The entire process typically takes 30-45 minutes depending on your vehicle size and the 
          package selected. You can watch the process or leave your vehicle with us - we're fully 
        ...
        <Text style={styles.bottomSheetText}>
          "Best car wash service I've ever used! My car looks brand new every time." - Rajesh K.{'\n'}
          "Professional, punctual, and thorough. Highly recommend!" - Priya M.{'\n'}
          "Great value for money. The team is friendly and does excellent work." - Amit S.
        </Text>
        ...
        <Text style={styles.bottomSheetText}>
          ...
          Book your service today and experience the difference professional car care makes!
        </Text>
      </View>
    </BottomSheetScrollView>
  );
